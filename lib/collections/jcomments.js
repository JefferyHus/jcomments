...
JCommentsCollection.schemas.CommentSchema = new SimpleSchema(getCommonCommentSchema({
  referenceId: {
    type: String
  }
}))

JCommentsCollection.attachSchema(CommentsCollection.schemas.CommentSchema)
